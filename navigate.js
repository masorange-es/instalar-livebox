...
const textos = [ 
				...
				'<strong>2.&nbsp;Enciende el Livebox.</strong><br><br>Pulsa el botón de encendido. Los tres LEDs se encenderán en color blanco fijo.<br><br>Espera aproximadamente 3 minutos hasta que el LED Internet permanezca en blanco fijo, el LED Wi-Fi en verde fijo y el LED Teléfono apagado.',
				...
				'Conecta un equipo al Livebox por cable (usando un puerto Gigabit Ethernet) o por Wi-Fi (usando la <strong>RED Wi-Fi</strong> y la <strong>CLAVE Wi-Fi</strong> que aparecen en la etiqueta debajo del router)<br><br>Accede mediante un navegador web a la página de configuración del router <strong>http://192.168.1.1</strong><br><br><u>Nota</u>: si vas a usar un smartphone, te recomendamos desactivar previamente la conexión de datos móviles, para usar la conexión Wi-Fi (no olvides activarla después al terminar la configuración).',
				...
				'<strong>3.&nbsp;Conecta tus equipos por Wi-Fi.</strong><br><br>Cuando el LED Wi-Fi pase a verde fijo podrás conectar tus equipos por Wi-Fi (portátiles, tablets, smartphones). Debes utilizar el nombre de <strong>RED Wi-Fi</strong> y la <strong>CLAVE Wi-Fi</strong> que aparecen en el lado izquierdo de la etiqueta debajo del router.<br><br>También puedes conectarte sin introducir la clave escaneando el código QR.',
